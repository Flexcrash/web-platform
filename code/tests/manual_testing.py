from persistence.data_access import UserDAO, MixedTrafficScenarioDAO, MixedTrafficScenarioTemplateDAO, TrainingScenarioTemplateDAO
...
def setup_testing_database(app):
    ...
    # TODO Not sure how this can be done better
    training_scenario_template_dao = TrainingScenarioTemplateDAO(app.config)
    try:
        training_scenario_template_dao.create_new_template(drive_straight_scenario_generation())
        training_scenario_template_dao.create_new_template(switch_lane())
